...
namespace QuizWebApp.Migrations
{
    ...
    [Migration("20250621230454_AddResultsToQuiz")]
    partial class AddResultsToQuiz
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizWebApp.Models.UserAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizWebApp.Models.UserQuizResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizWebApp.Models.Quiz", b =>
                {
                    b.HasOne("QuizWebApp.Models.ApplicationUser", "Creator")
                        .WithMany("Quizzes")
            ...
            modelBuilder.Entity("QuizWebApp.Models.UserAnswer", b =>
                {
                    ...
                    b.HasOne("QuizWebApp.Models.Answer", "SelectedAnswer")
                        .WithMany()
                        .HasForeignKey("SelectedAnswerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QuizWebApp.Models.UserQuizResult", "UserQuizResult")
                        .WithMany()
                        .HasForeignKey("UserQuizResultId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("QuizWebApp.Models.UserQuizResult", null)
                        .WithMany("Answers")
